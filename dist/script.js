...
/* harmony import */ var _modules_pictureHover__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/pictureHover */ "./src/js/modules/pictureHover.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_pictureHover__WEBPACK_IMPORTED_MODULE_9__["default"])('.sizes-block');
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var showMoreOne = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
    ...
    trigger.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        if (showMoreOne == false) {
          document.querySelectorAll(triggerSelector).forEach(function (item) {
            return item.remove();
          });
        }
      });
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true, false);
  openScroll('.fixed-gift');
  showModalByTime('.popup-consultation', 80000);
};
...
/***/ "./src/js/modules/pictureHover.js":
/*!****************************************!*\
  !*** ./src/js/modules/pictureHover.js ***!
  \****************************************/
/*! exports provided: default */
...
var pictureHover = function pictureHover(imgSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (pictureHover);
...
var scrolling = function scrolling(upSelector) {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var widthhTop = document.documentElement.scrollTop,
          hash = this.hash,
      ...
      function step(time) {
        ...
        var progress = time - start,
            r = toBlock < 0 ? Math.max(widthhTop - progress / speed, widthhTop + toBlock) : Math.min(widthhTop + progress / speed, widthhTop + toBlock);
        document.documentElement.scrollTo(0, r);

        if (r != widthhTop + toBlock) {
          requestAnimationFrame(step);
        } else {
          location.hash = hash;
        }
...
var showMoreStyles = function showMoreStyles(trigger, styles, wrapper) {
...
var sliders = function sliders(slides, direction, prev, next) {
  ...
  try {
    var pervBtn = document.querySelector(prev),
